    ...
    <div class="mx-auto max-w-5xl space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <a
                ...
                class="group space-y-4 rounded-xl border border-border bg-card p-5 transition hover:border-chart-1/40 hover:shadow-sm"
            >
            ...
            <a
                href="{{ route('project-detail.index') }}"
                class="group space-y-4 rounded-xl border border-border bg-card p-5 transition hover:border-chart-4/40 hover:shadow-sm"
            >
                <div class="flex items-center justify-between">
                    <span
            ...
            <a
                href="{{ route('project-detail.index') }}"
                class="group space-y-4 rounded-xl border border-border bg-card p-5 transition hover:border-chart-2/40 hover:shadow-sm"
            >
                <div class="flex items-center justify-between">
                    <span
